				...
				<div className="dib br3 mh4 mw5 mv3 shadow-3">
					<article>
						<div className={ styles.backgroundColor + ' tc pt4 br--top br3'}>
					  	...
					  	<svg style={{ display:'block' }} height="100%" width="100%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg" className="transition duration-300 ease-in-out delay-150">
					  		<path d="M 0,400 C 0,400 0,200 0,200 C 86.28571428571428,158.07142857142856 172.57142857142856,116.14285714285714 309,137 C 445.42857142857144,157.85714285714286 632.0000000000001,241.5 756,270 C 879.9999999999999,298.5 941.4285714285713,271.8571428571429 1045,251 C 1148.5714285714287,230.14285714285714 1294.2857142857142,215.07142857142856 1440,200 C 1440,200 1440,400 1440,400 Z" stroke="none" stroke-width="0" fill="#aee4f3ff" className="transition-all duration-300 ease-in-out delay-150" transform="rotate(-180 720 200)"></path>
					  	</svg>
