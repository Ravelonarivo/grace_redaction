					...
					<article>
						<div className="tc bg-white pt4 br--top br3">
					    	<DesktopOutline
							  ...
							  width="4rem"
							/>
					    	<h3 className={ styles.subTitle1 + ' f4 fw5 ma0 pt3' }>Rédaction</h3>
					  	</div>
					...
					<article>
						<div className="tc bg-white pt4 br--top br3">
					    	<DocumentTextOutline
							  ...
							  width="4rem"
							/>
					    	<h3 className={ styles.subTitle2 + ' f4 fw5 ma0 pt3' }>Réécriture</h3>
					  	</div>
					...
					<article>
						<div className="tc bg-white pt4 br--top br3">
					    	<CheckmarkDoneOutline
							  ...
							  width="4rem"
							/>
					    	<h3 className={ styles.subTitle3 + ' f4 fw5 ma0 pt3' }>Correction</h3>
					  	</div>
					  	<svg style={{ display:'block' }} height="100%" width="100%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg" className="transition duration-300 ease-in-out delay-150">
