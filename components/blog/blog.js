...
const Blog = ({ blogSectionRef }) => {
	return (
		<div ref={ blogSectionRef } id="blog" className="mt5 mh7">
			...
			<div className="dib pointer h5 w-100 mb4 ba b--black-10 pa3 shadow-4 br4 bg-white">
				<div className="fl h-100 w-70 pl3 pt2">
					...
					<p className={ styles.color + ' f6 lh-copy mv0' }>Par <span className="ttu">Toto</span></p>
    				<time className={ styles.color + ' f6 db fw5' }>21 Mars 2021</time>
				</div>
			...
			<div className="dib pointer h5 w-100 mb4 ba b--black-10 pa3 shadow-4 br4 bg-white">
				<div className="fl h-100 w-70 pl3 pt2">
					...
					<p className={ styles.color + ' f6 lh-copy mv0' }>Par <span className="ttu">Lulu</span></p>
    				<time className={ styles.color + ' f6 db fw5' }>10 Mars 2021</time>
				</div>
				<div className="fr h-100 w-30 tc pv2">
					<Image
						className={ styles.image + ' br-100'}
			...
			<div className="dib pointer h5 w-100 mb4 ba b--black-10 pa3 shadow-4 br4 bg-white">
				<div className="fl h-100 w-70 pl3 pt2">
					...
					<p className={ styles.color + ' f6 lh-copy mv0' }>Par <span className="ttu">Momo</span></p>
    				<time className={ styles.color + ' f6 db fw5' }>04 Février 2021</time>
				</div>
				<div className="fr h-100 w-30 tc pv2">
					<Image
						className={ styles.image + ' br-100'}
