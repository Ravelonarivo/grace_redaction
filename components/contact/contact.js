			...
			<svg style={{ display:'block' }} height="100%" width="100%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg" className="transition duration-300 ease-in-out delay-150">
				<defs>
					<linearGradient id="gradient">
						<stop stop-color="#93329E"></stop>
						<stop offset="100%" stop-color="#93329E"></stop>
					</linearGradient>
				</defs>
					...
					<div className="mh7 h-100">
						<div className="fl h-100 w-60 pv4 ph4">
							...
							<form className="mt4">
								...
								<input className={ styles.submitButton + ' pointer br-pill grow f5 white fw5 h2 ph4 b--dark-blue ba pb2' } type="submit" value="Envoyer"/>
							</form>
						</div>
						<div className={ styles.subTitle + " fr h-100 w-40 pv4 ph4 br--top br4" }>
